...
public class HelloOSS {
    ...
    private static String bucketName = "xdd-navy-oss";

    // Object是OSS存储数据的基本单元，称为OSS的对象，也被称为OSS的文件。详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Object命名规范如下：使用UTF-8编码，长度必须在1-1023字节之间，不能以“/”或者“\”字符开头。
    private static String firstKey = "my-first-key.jpg";

    public static void main(String[] args) {

        // 日志配置，OSS Java SDK使用log4j记录错误信息。下生成“oss-demo.log”日志文件，默认日志级别是INFO。
        ...
        try {
            ...
            InputStream aa = new FileInputStream(new File("G:\\xdd\\接受文件\\QQ图片20161221181542.jpg"));
            PutObjectResult putObjectResult = ossClient.putObject(bucketName, firstKey, aa);
    ...
    public void test1() throws Throwable{
        ...
        DownloadFileRequest downloadFileRequest = new DownloadFileRequest(bucketName, firstKey);
        // 设置本地文件
        downloadFileRequest.setDownloadFile("G:\\xdd\\aa.jpg");
        // 设置并发下载数，默认1
    ...
    public void test2() throws Throwable{
        OSSClient ossClient = getOSSClient();
        //InitiateMultipartUploadRequest request = new InitiateMultipartUploadRequest(bucketName, firstKey);
        UploadFileRequest uploadFileRequest = new UploadFileRequest(bucketName, firstKey);
        // 待上传的本地文件
        uploadFileRequest.setUploadFile("G:\\xdd\\aa.jpg");
        // 设置并发下载数，默认1
    ...
    public void test(){
        ...
        String name = "xdd-navy-oss";
        boolean b = client.doesBucketExist(name);
